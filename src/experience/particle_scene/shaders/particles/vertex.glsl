...
void main()
{
    ...
    float f = .525;
    float amplitude = 3.225;
    float maxDistance = (1.65 - .675*max(abs(uMouse.x), abs(uMouse.y))) * amplitude; //Lower values for maxDistance wrt amplitude result in noisier looking particles
